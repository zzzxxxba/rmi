...
public class justHungry2 extends UnicastRemoteObject implements FrontServerInterface{
	private List<Order> orderList;
	private List<CustomerOrder> customerOrderList;

	protected justHungry2(List<Order> list, List<CustomerOrder> list2) throws RemoteException {
		super();
		this.orderList = list;
	...
	public int addCustomerOrder(String postCode, String Order) throws RemoteException{
		...
		try{
			...
			try{
				...
				FileWriter myWriter = new FileWriter("server2.txt");
    ...
    public static void main(String args[]) {
		try {
			...
			registry.rebind("justHungry2", new justHungry(initializeList(),initializeCustomerList()));
